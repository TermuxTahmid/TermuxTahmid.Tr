...
def baner():
    clear()
    print(f"""
        {p}{b} ________  ______   __    __  __       __  ______  _______  
        {p}{b}/        |/      \ /  |  /  |/  \     /  |/      |/       \ 
        {p}{b}$$$$$$$$//$$$$$$  |$$ |  $$ |$$  \   /$$ |$$$$$$/ $$$$$$$  |
        {p}{b}   $$ |  $$ |__$$ |$$ |__$$ |$$$  \ /$$$ |  $$ |  $$ |  $$ |
        {p}{b}   $$ |  $$    $$ |$$    $$ |$$$$  /$$$$ |  $$ |  $$ |  $$ |
        ...
        {p}{b}   $$/   $$/   $$/ $$/   $$/ $$/      $$/ $$$$$$/ $$$$$$$/    
{ab}-----------------------------------------------
{d}From   : {g}Bangladesh(Dhaka Hacker)
{d}Message  : {g}https://wa.me/Tahmid Xhowdhury
{d}Restapi  : {g}NAI
{d}Youtube  : {g}Nai
{d}Github   : {g}https://github.com/TermuxTahmid
{d}Facebook : {g}https://www.facebook.com/tahmid.xhowdhury.201
{ab}-----------------------------------------------""")
